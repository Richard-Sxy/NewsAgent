...
export async function handler(
  ...
  const {
    ...
    datasetSearchUsingQueryRewrite = false,
    datasetSearchQueryRewriteModel,
  ...
  const searchData = {
    ...
    usingQueryRewrite: datasetSearchUsingQueryRewrite,
    queryRewriteModel: datasetSearchQueryRewriteModel,
